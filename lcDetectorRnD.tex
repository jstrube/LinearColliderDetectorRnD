...
\newpage
\includepdf[pages={-},angle=90,pagecommand={\thispagestyle{empty}}]{VertexDetector/PixelsTable.pdf}
...
\input{Software/LCIO/LCIO.tex}
\input{Software/LCSim/LCSim.tex}
\input{Software/PandoraPFA/PandoraPFA.tex}
\printbibliography
\end{document}
